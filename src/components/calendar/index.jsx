...
import { throttle, formatMonthData, formatWeekData } from '../../util/fun'

import { rightArrowIcon, downDoubleArrowIcon } from '../../util/img'
import './index.less'
...
class Calendar extends PureComponent {
  ...
  render() {
    ...
    const isMonthView = showType === 'month'
    return (
      <div className="visual-design-calendar">
        ...
        {disableWeekView ? null : (
          <div className="bottom-operate">
            <img className={isMonthView ? 'top' : 'down'} src={downDoubleArrowIcon} />
          </div>
        )}
      </div>
    )
